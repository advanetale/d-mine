...
На нашем сервере вы можете превратить любую цветную керамику обратно в обычную терракоту с помощью камнереза.

### Использование камнереза для терракоты

1. Поместите любую цветную керамику в камнерез
...
_Рецепт получения терракоты из белой керамики в камнерезе_
