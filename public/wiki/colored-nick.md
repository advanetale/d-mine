...
![ник](/wiki-images/nick.png)

Использование: /nick <код из генератора цветного ник> (Используйте только в лобби! После применения он автоматически установится на все сервера.)
